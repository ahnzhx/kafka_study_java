...
public class KafkaConfig {
    ...
    private static String MSG_FILTER_CONTENT = "HELLO";

    @Bean
    public KafkaAdmin kafkaAdmin(){
        Map<String, Object> kafkaAdminMap = new HashMap<>();
        kafkaAdminMap.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        return new KafkaAdmin(kafkaAdminMap);
    }
